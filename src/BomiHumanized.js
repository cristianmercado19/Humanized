...
Humanized.Actions.Initializer = Humanized.Actions.Initializer || {
    ...
    init : function (){
        ...
        Humanized.Actions.ButtonElements.Initializer.init();
...
Humanized.Actions.Custom.Initializer = Humanized.Actions.Custom.Initializer || {
    ...
    _addRefreshAction : function () {
        var action = function () {
            window.Humanized.Actions.Initializer.refreshActions();
        };

        this._addACustomAction("refresh", action);
    },
...
Humanized.InputInitializer = Humanized.InputInitializer || {
    ...
    _initializeSearchInput : function(){
        var searchInputId = Humanized.Var.searchInputId;
        Humanized.Var.searchInput = Humanized.Var.jq311("<input id='" + searchInputId + "' class='searchInputId' />");
    },

    _initializeSearchDiv: function(){
        Humanized.Var.searchDiv = Humanized.Var.jq311("<div id='mySearchDiv' ></div>");
    },

    _initializeLists: function() {
        Humanized.Var.actionDictionary = [];
        Humanized.Var.actionList = [];
    },
...
Humanized.Actions.ButtonElements = Humanized.Actions.ButtonElements|| {};

Humanized.Actions.ButtonElements.Initializer = Humanized.Actions.ButtonElements.Initializer || {
    ...
    _isAValidAction : function(aElement, text){
        ...
        var isAValidAction = (atLeastThreeCharacters);
    ...
    _createListOfActions: function(){
        ...
        Humanized.Var.jq311("button[name*='InvokeAction']").each(function( index ) {
